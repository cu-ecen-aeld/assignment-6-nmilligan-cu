...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-nmilligan-cu;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
# set to reference a specific commit hash in your assignment repo
SRCREV = "1c3f960ba110a8746d50682b96fcea325c7808a5"
